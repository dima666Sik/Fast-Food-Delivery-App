...
public interface ProductStatusLikesRepository extends JpaRepository<ProductStatusLikes, Long> {
    Optional<ProductStatusLikes> findByProduct_IdAndUser_Id(Long productId, Long userId);
